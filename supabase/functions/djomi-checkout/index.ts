...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .container.center { align-items: center; text-align: center; }
      ...
      <button id="pay-btn" class="cta-btn">
        <span class="pay-row">
          ...
          <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
            <circle cx="9" cy="9" r="9" fill="#FF7900" />
            <text x="9" y="12.3" font-size="7.2" font-weight="700" fill="#fff" text-anchor="middle" font-family="Arial, sans-serif">OM</text>
          </svg>
